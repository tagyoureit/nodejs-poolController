            ...
            function process(data, counter) {
              ...
              if (JSON.stringify(data) !== JSON.stringify(container.circuit.getCurrentStatusBytes())) {
                container.circuit.setCurrentStatusBytes(data, counter)
                  ...
                  container.temperatures.setTempFromController(data[c.controllerStatusPacketFields.POOL_TEMP],data[c.controllerStatusPacketFields.SPA_TEMP],data[c.controllerStatusPacketFields.AIR_TEMP],data[c.controllerStatusPacketFields.SOLAR_TEMP], data[c.controllerStatusPacketFields.UOM] & 8)
