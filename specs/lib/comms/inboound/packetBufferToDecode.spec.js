describe('recieves packets from buffer and follows them to decoding', function() {
    ...
    describe('#When packets arrive', function() {
        context('via serialport or Socat', function() {
            ...
            it('#decodes pump 1 power off command from the controller', function() {
            ...
            it('#decodes pump 1 power on command from the controller', function() {
                // console.log('getCurrentPumpStatus(1):', bottle.container.pump.getCurrentPumpStatus(1))
                bottle.container.pump.getPower(1).should.eq('powernotset')
            ...
            it('#decodes pump 1 remote control on command from the controller', function() {
                // console.log('getCurrentPumpStatus(1):', bottle.container.pump.getCurrentPumpStatus(1))
            ...
            it('#decodes pump 2 remote control off command from the controller', function() {
                // console.log('getCurrentPumpStatus(1):', bottle.container.pump.getCurrentPumpStatus(1))
