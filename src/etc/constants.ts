...
//  along with this program.  If not, see <http://www.gnu.org/licenses/>.
    ...
    export let controllerStatusPacketFields:Constants.StringLookup = {
        HOUR: 6,
        MIN: 7,
        EQUIP1: 8,
        EQUIP2: 9,
    ...
    export let controllerChlorinatorPacketFields:Constants.StringLookup = {
        OUTPUTSPAPERCENT: 6,
        OUTPUTPERCENT: 7,
        SALTPPM: 9,
        STATUS: 10,
    ...
    export let chlorinatorPacketFields:Constants.StringLookup = {
        DEST: 2,
        ACTION: 3
    }

    export let pumpPacketFields:Constants.StringLookup = {
        DEST: 2,
        FROM: 3,
        ACTION: 4,
        LENGTH: 5,
    ...
    export let pumpConfigFieldsCommon:Constants.StringLookup = {
        NUMBER: 6,
        TYPE: 7
    }

    export let pumpConfigFieldsVS:Constants.StringLookup = {
        PRIMINGMINS: 8,
        UNKNOWNCONSTANT_9: 9,
        UNUSED_10: 10,
        CIRCUIT1: 11,
    ...
    export let pumpConfigFieldsVSF:Constants.StringLookup = {
    ...
    export let namePacketFields:Constants.StringLookup = {
        NUMBER: 6,
        CIRCUITFUNCTION: 7,
        NAME: 8,
    }

    export let pumpAction:Constants.IndexLookup = {
    ...
    export let strCircuitName:Constants.IndexLookup = {
        0: 'NOT USED',
        1: 'AERATOR',
        2: 'AIR BLOWER',
        3: 'AUX 1',
    ...
    export let strCircuitFunction:Constants.IndexLookup = {
        0: 'Generic',
        1: 'Spa',
        2: 'Pool',
        5: 'Master Cleaner',
    ...
    export let strPumpActions:Constants.IndexLookup = {
    ...
    export let strChlorinatorActions:Constants.IndexLookup = {
        0: 'Get Status',
    ...
    export let strControllerActions:Constants.IndexLookup = {
    ...
    export let lightColors:Constants.IndexLookup = {
        0: "White",
    ...
    export let strIntellibriteModes:Constants.IndexLookup = {
        0: 'Off',
        1: 'On',
        128: 'Color Sync',
        144: 'Color Swim',
    ...
    export let intellibriteModes:Constants.StringLookup = {
        'Off': 0,
        'On': 1,
        'Color Sync': 128,
        'Color Swim': 144,
    ...
    export let strRunMode:Constants.IndexLookup = {
    ...
    export let strValve:Constants.IndexLookup = {
        3: 'Pool',
        15: 'Spa',
        48: 'Heater',
        51: 'Solar'
    ...
    export let heatModeStr:Constants.IndexLookup = {
    ...
    export let heatMode:Constants.StringLookup = {
        OFF: 0,
        HEATER: 1,
        SOLARPREF: 2,
        SOLARONLY: 3
    ...
    export let ctrl:Constants.StringLookup = {
        CHLORINATOR: 2,
        BROADCAST: 15,
        INTELLITOUCH: 16,
        REMOTE: 32,
    ...
    export let ctrlString:Constants.IndexLookup = {
        2: 'Chlorinator',
        15: 'Broadcast',
        16: 'Main',
        32: 'Remote',
    ...
    export let schedulePacketBytes:Constants.StringLookup = {
        "ID": 6,
        "CIRCUIT": 7,
        "TIME1": 8,
        "TIME2": 9,
    ...
    export let intellichemPacketFields:Constants.StringLookup = {
        DEST: 2,
        ACTION: 3,
        PHREADINGHI: 6,
        PHREADINGLO: 7,
    ...
    export let intellicenterPackets:Constants.IndexLookup = {
        30: 'Configuration Request/Response',

        164: 'Heat Source',
        204: 'ummm'
    }

    export let intellicenterConfigurationSubItem = {
        
    }

    export let intellicenterConfigurationItem:Constants.IndexLookup = {
        1: 'Circuits',
        2: 'Features',
        3: 'Schedules',
        4: 'Pumps',
        6: 'Light Groups',
        7: 'Chemistry Controllers',
        9: 'Valves',
        10: 'Heaters',
        12: 'General Settings',
        13: 'Panel Configuration',
        15: 'Body Configuration'
        // (this list will be expanded as they are discovered) Remotes and Covers outstanding.
    }

    export let intellicenterCircuitFunctions:Constants.IndexLookup = {
        0: 'Spa',
        1: 'Spillway',
        2: 'Master Cleaner',
        3: 'Chem Relay',
