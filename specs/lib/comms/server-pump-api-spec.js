...
describe('#set functions', function() {
    ...
    describe('#sends pump commands', function() {
        context('with a HTTP REST API', function() {
            ...
            it('runs pump 1, program 1', function(done) {
            ...
            it('runs pump 1, program 1 for 600 minutes ', function() {
            ...
            it('runs pump 1, program 2 for 10 minutes ', function() {
            ...
            it('runs pump 2, rpm 1000', function(done) {
            ...
            it('runs pump 2, rpm 1000 for 600 minutes ', function(done) {
            ...
            it('runs pump 1, program 1 (NEW URL)', function(done) {
            ...
            it('runs pump 1, rpm 1000 1 (NEW URL)', function(done) {

                requestPoolDataWithURL('pumpCommand/run/pump/1/rpm/1').then(function(obj) {
                    // console.log('obj: ', obj)
                    obj.text.should.contain('REST API')
                    obj.pump.should.eq(1)
                    obj.duration.should.eq(-1)
            ...
            it('runs pump 2, rpm 1000, duration 600, then turns it off', function(done) {
            ...
            it('turns on pump 1 for 15 minutes', function(done) {
                bottle.container.settings.logPumpTimers = 1
                bottle.container.settings.logPumpMessages = 1
                requestPoolDataWithURL('pumpCommand/on/pump/1/duration/15').then(function(obj) {
                    obj.text.should.contain('REST API')
                    obj.pump.should.eq(1)
                    // obj.duration.should.eq(600)
                    // console.log('pumpQueue:', queuePacketStub.args)
    ...
    describe('#sends on->off pump commands in subsequent calls', function() {
        context('with a HTTP REST API', function() {
            ...
            it('turns on pump 1', function(done) {

                requestPoolDataWithURL('pumpCommand/on/pump/1').then(function(obj) {
                    obj.text.should.contain('REST API')
                    obj.pump.should.eq(1)
                    // obj.duration.should.eq(600)
                    // console.log('pumpQueue:', queuePacketStub.args)
            ...
            it('turns off pump 1', function(done) {
            ...
            it('turns on pump 2', function(done) {

                requestPoolDataWithURL('pumpCommand/on/pump/2').then(function(obj) {
                    obj.text.should.contain('REST API')
                    obj.pump.should.eq(2)
                    // obj.duration.should.eq(600)
                    // console.log('pumpQueue:', queuePacketStub.args)
            ...
            it('turns off pump 2', function(done) {
